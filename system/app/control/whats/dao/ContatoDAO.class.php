...
class ContatoDAO 
{
    ...
    private $tpdo = null;
    private $repositoryName = 'contato'; //Nome da Classe do tipo Active Record no diretorio /app/model/maindatabase
    ...
    private function processWhereGridParameters( $whereGrid )
    {
        ...
        if ( is_array($whereGrid) ){
            SqlHelper::setDbms($this->tpdo->getType());
            $where = ' 1=1 ';
            $connetor = SqlHelper::SQL_CONNECTOR_AND;
            $dbms = $this->tpdo->getDbms();
            $where = SqlHelper::getAtributeWhereGridParameters($where, $whereGrid, 'ID_CONTATO', SqlHelper::SQL_TYPE_NUMERIC,true,$connetor,$dbms);
            $where = SqlHelper::getAtributeWhereGridParameters($where, $whereGrid, 'NOME', SqlHelper::SQL_TYPE_TEXT_LIKE,true,$connetor,$dbms);
            $where = SqlHelper::getAtributeWhereGridParameters($where, $whereGrid, 'DDI', SqlHelper::SQL_TYPE_TEXT_LIKE,true,$connetor,$dbms);
            $where = SqlHelper::getAtributeWhereGridParameters($where, $whereGrid, 'DDD', SqlHelper::SQL_TYPE_TEXT_LIKE,true,$connetor,$dbms);
            $where = SqlHelper::getAtributeWhereGridParameters($where, $whereGrid, 'CELULAR', SqlHelper::SQL_TYPE_TEXT_LIKE,true,$connetor,$dbms);
            $where = SqlHelper::getAtributeWhereGridParameters($where, $whereGrid, 'ST_WHATSAPP', SqlHelper::SQL_TYPE_TEXT_LIKE,true,$connetor,$dbms);
            $where = SqlHelper::getAtributeWhereGridParameters($where, $whereGrid, 'AVISADO', SqlHelper::SQL_TYPE_TEXT_LIKE,true,$connetor,$dbms);
            $where = SqlHelper::getAtributeWhereGridParameters($where, $whereGrid, 'DTINCLUSAO', SqlHelper::SQL_TYPE_TEXT_LIKE,true,$connetor,$dbms);
            $where = SqlHelper::getAtributeWhereGridParameters($where, $whereGrid, 'DTALTERACAO', SqlHelper::SQL_TYPE_TEXT_LIKE,true,$connetor,$dbms);
            $where = SqlHelper::getAtributeWhereGridParameters($where, $whereGrid, 'DTEXCLUSAO', SqlHelper::SQL_TYPE_TEXT_LIKE,true,$connetor,$dbms);
            $result = $where;
        }
        return $result;
    }
    ...
    public function selectById( $id )
    {
        ...
        $values = array($id);
        $sql = self::$sqlBasicSelect.' where id_contato = ?';
    ...
    public function selectCount( $where=null )
    {
        ...
        $sql = 'select count(id_contato) as qtd from contato';
    ...
    //--------------------------------------------------------------------------------
    public function insert( ContatoVO $objVo )
    {
        $values = array(  $objVo->getNome() 
                        , $objVo->getDdi() 
                        , $objVo->getDdd() 
                        , $objVo->getCelular() 
                        , $objVo->getSt_whatsapp() 
                        , $objVo->getAvisado() 
                        , $objVo->getDtinclusao() 
                        , $objVo->getDtalteracao() 
                        , $objVo->getDtexclusao() 
                        );
    ...
    //--------------------------------------------------------------------------------
    public function update ( ContatoVO $objVo )
    {
        $values = array( $objVo->getNome()
                        ,$objVo->getDdi()
                        ,$objVo->getDdd()
