...
class MensagemDAO 
{
    ...
    private $tpdo = null;
    private $repositoryName = 'mensagem'; //Nome da Classe do tipo Active Record no diretorio /app/model/maindatabase
    ...
    private function processWhereGridParameters( $whereGrid )
    {
        ...
        if ( is_array($whereGrid) ){
            ...
            $where = SqlHelper::getAtributeWhereGridParameters($where, $whereGrid, 'ID_MENSAGEM', SqlHelper::SQL_TYPE_NUMERIC,true,$connetor,$dbms);
            $where = SqlHelper::getAtributeWhereGridParameters($where, $whereGrid, 'MENSAGEM', SqlHelper::SQL_TYPE_TEXT_LIKE,true,$connetor,$dbms);
    ...
    public function selectById( $id )
    {
        ...
        $values = array($id);
        $sql = self::$sqlBasicSelect.' where id_mensagem = ?';
    ...
    public function selectCount( $where=null )
    {
        ...
        $sql = 'select count(id_mensagem) as qtd from mensagem';
    ...
    //--------------------------------------------------------------------------------
    public function insert( MensagemVO $objVo )
    {
        $values = array(  $objVo->getMensagem() 
                        , $objVo->getDtinclusao() 
    ...
    //--------------------------------------------------------------------------------
    public function update ( MensagemVO $objVo )
    {
        $values = array( $objVo->getMensagem()
                        ,$objVo->getDtinclusao()
                        ,$objVo->getDtalteracao()
                        ,$objVo->getDtexclusao()
                        ,$objVo->getId_mensagem() );
